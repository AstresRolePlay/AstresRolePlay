...
local dir = "celestia_scoreboard"

local function NicePrint(txt)
	if SERVER then
		MsgC(Color(239, 57, 11), txt .. "\n")
	else
		MsgC(Color(150, 23, 29), txt .. "\n")
	end
end
...
local function Initialize()
	NicePrint("")
	NicePrint("///////////////////////////////////////////////////")
	NicePrint("///////////// celestia Scoreboard //////////////////")
	NicePrint("///////////////////////////////////////////////////")
	PreLoadFile("celestia_scoreboard_config.lua")
	LoadFiles(dir)
	NicePrint("///////////////////////////////////////////////////")
	NicePrint("//         celestia Scoreboard initiated          //")
	NicePrint("///////////////////////////////////////////////////")
	NicePrint("")
end
...
timer.Simple(0,function()
    if CelestiaLib == nil then
		...
		MsgC(Color(255, 0, 0), "[astres Scoreboard] : CelestiaLib is missing, please install it on the workshop.")
		...
		if SERVER then
			for k,v in ipairs(player.GetAll()) do
				if IsValid(v) then
					Warning(v, "[astres Scoreboard] : CelestiaLib is missing, please install it on the workshop.")
