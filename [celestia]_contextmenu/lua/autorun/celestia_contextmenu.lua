...
local dir = "celestia_contextmenu"
...
local function Initialize()
	NicePrint("")
	NicePrint("///////////////////////////////////////////////////")
	NicePrint("///////////////// celestia Contexte Menu //////////")
	NicePrint("///////////////////////////////////////////////////")
	PreLoadFile("Celestia_contextmenu_config.lua")
	
	LoadFiles(dir)
	NicePrint("///////////////////////////////////////////////////")
	NicePrint("//             celestia Contexte initiated       //")
	NicePrint("///////////////////////////////////////////////////")
	NicePrint("//     This addon is created by petitbiscuitqc  //")
	NicePrint("///////////////////////////////////////////////////")
	NicePrint("//         Discord : petitbiscuitqc              //")
	NicePrint("///////////////////////////////////////////////////")
	NicePrint("")
end
